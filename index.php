...
<nav class="navbar navbar-inverse">
  ...
  <div class="container bg-4">
      <span class="ending">Oh fun fact: This page has been accessed <?php
        $hitfile = fopen("numberOfHits.txt","r") or die("Unable to open file");
        $val = fread($hitfile,filesize("numberOfHits.txt"));
        $val = $val + 1;  
        echo $val;  
        fclose($hitfile);
        $hitfile = fopen("numberOfHits.txt","w") or die("Unable to open file");
        fwrite($hitfile,"$val");  
        fclose($hitfile);
      ?> time(s) since the last time I reset the timer. Maintained using PHP. Liked this page? How can I improve on this? Give a feedback <a href="./feedback.php">here</a>, and view all past feedbacks <a href="./allfeedbacks.php">here</a></span>
  </div>
